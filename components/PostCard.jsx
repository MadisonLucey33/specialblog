...
const PostCard = ({ post }) => {
  ...
  return ( // sm:bg-red-600 md:bg-gray-600 lg:bg-yellow-300 xl:bg-green-500 2xl:bg-cyan-400 3xl:bg-indigo-600 4xl:bg-violet-800
    <div className="bg-white shadow-lg rounded-lg p-0  pb-12 mb-8 sm:bg-red-600 md:bg-gray-600 lg:bg-yellow-300 xl:bg-green-500 2xl:bg-cyan-400 3xl:bg-indigo-600 4xl:bg-violet-800">
